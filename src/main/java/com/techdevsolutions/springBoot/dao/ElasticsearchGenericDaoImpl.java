...
public class ElasticsearchGenericDaoImpl implements DaoCrudInterface<Map> {
    ...
    public ElasticsearchGenericDaoImpl(Environment environment) {
        ...
        if (environment != null) {
            ...
            if (StringUtils.isNotEmpty(host)) {
                this.ES_HOST = host;
                this.logger.debug("Setting ES_HOST: " + this.ES_HOST);
            }
            ...
            if (StringUtils.isNotEmpty(host)) {
                ...
                this.logger.debug("Setting ES_PORT: " + this.ES_PORT);
            }
            ...
            if (StringUtils.isNotEmpty(protocol)) {
                ...
                this.logger.debug("Setting ES_PROTOCOL: " + this.ES_PROTOCOL);
            }
            ...
            if (StringUtils.isNotEmpty(username)) {
                ...
                this.logger.debug("Setting ES_USERNAME: " + this.ES_USERNAME);
            }
            ...
            if (StringUtils.isNotEmpty(password)) {
                ...
                this.logger.debug("Setting ES_PASSWORD: REDACTED");
            }
            ...
            if (StringUtils.isNotEmpty(certificatePath)) {
                ...
                this.logger.debug("Setting ES_CERT_PATH: " + this.ES_CERT_PATH);
            }
    ...
    public void install() throws Exception {
        ...
        logger.debug("Elasticsearch mapping: " + mapping);
