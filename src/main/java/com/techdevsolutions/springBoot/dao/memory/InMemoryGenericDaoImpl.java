...
@Repository
public class InMemoryGenericDaoImpl implements DaoCrudInterface<Object> {
    ...
    @Override
    public Object create(final String id, final Object item) throws IllegalArgumentException {
        if (item == null) {
    ...
    public void remove(final String id) throws IllegalArgumentException,NoSuchElementException {
        if (StringUtils.isEmpty(id)) {
            ...
            throw new NoSuchElementException("Unable to find item");
        }
    ...
    public Object update(final String id, final Object item) throws IllegalArgumentException,NoSuchElementException {
        ...
        Optional<Object> optional = this.get(id);
